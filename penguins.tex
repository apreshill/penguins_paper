...
\abstract{%
Edgar Anderson's famous 1935 \emph{Iris} dataset, which exists in the
base R \textbf{datasets} package as \textbf{iris}, is ubiquitous in
statistics and data science education. Due to a lack of metadata,
non-intuitive variables (e.g.~Sepal.Width), its publication in (and
inextricable connection with) Fisher's 1936 paper in \emph{Annals of
Eugenics}, and perfect structure (e.g.~no missing values)
