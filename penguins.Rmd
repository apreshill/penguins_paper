...
Given the need for fresh data science-ready datasets, we wanted to find a suitable alternative dataset that we could make easy to access for everyone. After evaluating the positive and negative features of the *Iris* dataset in data science and statistics materials, we established the following criteria for a suitable alternative:
